<!-- 自动生成 by platform/tools/export_integration_kit.py —— 勿手改。源文件：platform/docs/metadata-conventions.md。改源后重跑脚本重生成本包。 -->
...
>
> **生效日期**：`chapter_type` 约定 2026-06-04 起生效（首个登记方 aird-report）。其余为初始约定。
